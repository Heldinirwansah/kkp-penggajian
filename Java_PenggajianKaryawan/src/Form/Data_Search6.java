 ...
 * @author syahrul
 */
public class Data_Search6 extends javax.swing.JFrame {
    private DefaultTableModel model;
    public absenuser au = null;
    ...
    private void tblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblMouseClicked
       int tabelKry = tbl.getSelectedRow();
        au.idKry = tbl.getValueAt(tabelKry, 0).toString();
       // ft.golKry = tbl.getValueAt(tabelKry, 7).toString();
        au.itemTerpilih();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Data_Search6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Data_Search6().setVisible(true);
            }
        });
    }
