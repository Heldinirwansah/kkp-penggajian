...
//                +"values('"+vNm+"','"+vTgl+"','"+vJk+"','"+vAl+"','"+vHp+"','"+vJbt+"','"+vGol+"')";
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(30, 30, 30)
                .addComponent(jbtt, 0, 148, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void jbttActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbttActionPerformed

    }//GEN-LAST:event_jbttActionPerformed
    ...
    private javax.swing.JComboBox<String> jbtt;
