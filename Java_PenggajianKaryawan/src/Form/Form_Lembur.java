...
//    }
    ...
    public void save(){
        ...
        String sql = "Insert into lembur(nama,jabatan,jml_jam,gaji_perjam,total)"
                +"values('"+vNm+"','"+vJbt+"','"+vJj+"','"+vGj+"','"+vTot+"')";
    ...
    public void selectData(){
        ...
        jj.setText(""+model.getValueAt(i, 3));
        gj.setText(""+model.getValueAt(i, 4));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jj, javax.swing.GroupLayout.PREFERRED_SIZE, 77, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
